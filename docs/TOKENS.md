...
- `icon.checkbox.{default}` - Checkbox icon sizes
...
- `button.gap.icon` - Icon gap spacing
- `chip.gap.icon` - Icon gap spacing
- `alert.gap.icon` - Icon gap spacing
- `toast.gap.icon` - Icon gap spacing
...
- `alert.danger.icon` - Icon color
- `toast.icon` - Icon color
- `toast.danger.icon` - Icon color
...
- `button.icon.only.padding` - Icon-only button padding
...
*Documentation generated on 2026-01-12T20:23:34.458Z*
