...
const semantic = JSON.parse(fs.readFileSync(path.join(tokensDir, 'output', 'semanticTokens.json'), 'utf8'));
const components = JSON.parse(fs.readFileSync(path.join(tokensDir, 'output', 'componentTokens.json'), 'utf8'));
