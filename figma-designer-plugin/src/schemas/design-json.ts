...
export type PluginMessage =
  ...
  | { type: 'PAIR_VARIABLES'; payload: DesignJson };
...
export type UIMessage =
  ...
  | { type: 'PAIRING_RESULT'; result: VariablePairingResult };
...
/** Variable pairing result - maps Design JSON variables to Figma variables */
export interface VariablePairingResult {
  ...
  paired: Array<{
    ...
    figmaName: string;
    figmaId: string;
    status: 'found' | 'alias_matched' | 'created';
    aliasTarget?: string;
  }>;
  missing: Array<{
    cssVar: string;
