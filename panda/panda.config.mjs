...
// Panda CSS uses .mjs for compatibility
import { loadTokens } from "@tokens/scripts/load-tokens.mjs";

// Load tokens from subfolders
...
export default defineConfig({
  preflight: true,
  include: ["../storybook/stories/**/*.{js,jsx,ts,tsx}"],
  exclude: [],
