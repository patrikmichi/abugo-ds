---
name: text-optical-alignment
description: Text and icon optical alignment patterns. Padding compensation and flex alignment for descender spacing in components.
...
**Why:** In flex containers with `align-items: stretch`, using `align-self: center` vertically centers icons relative to the text content.
...
1. **Container**: Use `align-items: stretch` on flex containers
