...
Create a new component with the following structure. Ask for the component name if not provided via $ARGUMENTS.
...
Follow the **token-structure** and **component-tokens** skills for naming conventions.
